...
#lgrb-test
COPY res/services-test.lgrb-bw.pem /tmp/certificate.pem
RUN /usr/lib/jvm/java-8-openjdk-amd64/jre/bin/keytool -importcert -noprompt -trustcacerts -file /tmp/certificate.pem -keystore /usr/lib/jvm/java-8-openjdk-amd64/jre/lib/security/cacerts -alias test-lgrb.bw.de -storepass changeit

# hzinfra
COPY res/_.hzinfra.hr /tmp/certificate.pem
RUN /usr/lib/jvm/java-8-openjdk-amd64/jre/bin/keytool -importcert -noprompt -trustcacerts -file /tmp/certificate.pem -keystore /usr/lib/jvm/java-8-openjdk-amd64/jre/lib/security/cacerts -alias hzinfra -storepass changeit
